...
from application.users.schemas import RegisterSchema, UserSchema, LoginSchema, ChangePwdSchema
from application.users.services import register_user, login_user, logout_user, get_user_by_id, change_password, change_profile_img
from application.users.decorators import login_required
from application.exceptions import OperationNotPermitted
...
def get_podcast_image(filename):
    return send_from_directory('application/static/avatars', filename)
