...
from application.users.models import User, BlackListedToken
from app import db
...
def save_avatar(file):
    ...
    file_path = os.path.join(app.root_path, 'application/static/avatars', new_filename)
...
def change_profile_img(user, img):
    ...
    if old_avatar != 'default.jpg':
        os.remove(os.path.join(app.root_path, 'application/static/avatars', old_avatar))
